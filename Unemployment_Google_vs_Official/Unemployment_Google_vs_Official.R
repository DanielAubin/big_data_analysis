### HEADER ###
# ------------------------------------------------------  
# Name of QuantLet:  Stacked Barplot
# ------------------------------------------------------  
...
# Author:  New
# ------------------------------------------------------  
# Submitted:  Daniel Jacob, 2015/10/15
# ------------------------------------------------------  
...
# Step 3: Revome the legend from the plot
